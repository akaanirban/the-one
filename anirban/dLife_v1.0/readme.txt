...
NOTE: this implementation considered the DecisionEngineRouter.java and RoutingDecisionEngine.java implemented by PJ Dillon which were adapted to run Dlife.java and DlifeComm.java
...
iv) Add DecisionEngineRouter and RoutingDecisionEngine to routing

================================

v) Add Dlife and DlifeComm to routing.community
