 ...
 * be configured.
 */
public class PayloadMessageEventGenerator implements EventQueue {
     ...
     */
    public PayloadMessageEventGenerator(Settings s){
    ...
    public ExternalEvent nextEvent() {
        ...
        MessageCreateEvent mce = new PayloadMessageCreateEvent(from, to, this.getID(),
